...
single_display = {
    ...
    {"IntelliJ IDEA",     nil,          display_primee, hs.layout.maximized,    nil, nil},
...
single_display_split = {
    ...
    {"Google Chrome",     nil,          display_primee, hs.layout.left50,       nil, nil},
    {"Code",              nil,          display_primee, hs.layout.left50,       nil, nil},
    {"Xcode",             nil,          display_primee, hs.layout.right50,      nil, nil},
    {"IntelliJ IDEA",     nil,          display_primee, hs.layout.right50,      nil, nil},
    {"ReadKit",           nil,          display_primee, hs.layout.left50,       nil, nil},
    {"Charles",           nil,          display_primee, hs.layout.right50,      nil, nil},
    {"Slack",             nil,          display_primee, hs.layout.left50,       nil, nil},
    ...
    {"Spotify",           nil,          display_primee, hs.layout.left50,       nil, nil},
    {"iTunes",            "MiniPlayer", display_primee, nil,                    nil, hs.geometry.rect(575, -45, 215, 45)},
    {"Finder",            nil,          display_primee, hs.layout.maximized,    nil, nil},
}
...
double_display = {
    ...
    {"Google Chrome",     nil,          display_middle, hs.layout.left50,       nil, nil},
    {"Code",              nil,          display_middle, hs.layout.right50,      nil, nil},
    {"Xcode",             nil,          display_middle, hs.layout.right50,      nil, nil},
    {"IntelliJ IDEA",     nil,          display_middle, hs.layout.right50,      nil, nil},
...
triple_display = {
    ...
    {"Xcode",             nil,          display_middle, hs.layout.right50,      nil, nil},
    {"IntelliJ IDEA",     nil,          display_middle, hs.layout.right50,      nil, nil},
    {"ReadKit",           nil,          display_middle, hs.layout.left50,       nil, nil},
